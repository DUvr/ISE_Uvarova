...
namespace AbstractShopView
{
    public partial class FormTakeOrderInWork : Form
    {
        ...
        private readonly IAdministrantService serviceI;

        private readonly IMainService serviceM;

        private int? id;

        public FormTakeOrderInWork(IAdministrantService serviceI, IMainService serviceM)
        {
            InitializeComponent();
        ...
        private void FormTakeOrderInWork_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                List<AdministrantViewModel> listI = serviceI.GetList();
                if (listI != null)
                {
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                serviceM.TakeOrderInWork(new SafetySystemBM
                {
                    Id = id.Value,
